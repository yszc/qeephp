...
function ___uri_filter()
{
    ...
    $_GET[Qee::getAppInf('controllerAccessor')] = isset($parts[0]) ? $parts[0] : '';
    $_GET[Qee::getAppInf('actionAccessor')] = isset($parts[1]) ? $parts[1] : '';

    $style = Qee::getAppInf('urlParameterPairStyle');
    if ($style == '/') {
