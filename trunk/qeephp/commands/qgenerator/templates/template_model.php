...
/**
 * 定义 <?php echo $class_name; ?> 和 <?php echo $class_name; ?>_Exception 类
 */
...
?>
                '<?php echo $name; ?>' => <?php if ($f['ptype'] != 'i') : ?>self::AUTOFILL_DATETIME <?php else : ?>self::AUTOFILL_TIMESTAMP <?php endif; ?>,
<?php
endforeach;
?>
			),
