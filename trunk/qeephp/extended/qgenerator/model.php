...
class QGenerator_Model extends QGenerator_Abstract
{
     ...
     */
    function generate($model_name, $table_name)
    {
        $class_name = $this->_normalizeClassName($model_name);
        $dir = rtrim($this->_reflection_module->moduleDir(), '/\\') . '/model';
        ...
        $dsn = $this->_reflection_module->reflectionApp()->getIni('db_dsn_pool/default');
        $dbtype = $dsn['driver'];
