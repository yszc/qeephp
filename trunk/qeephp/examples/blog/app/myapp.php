 ...
 * 应用程序对象
 */
class ExampleBlogApp extends QApplication_Abstract
{
    /**
     * 构造函数
     *
    ...
    static function instance(array $app_config = null)
    {
        ...
        if (is_null($app))
        {
            $app = new ExampleBlogApp($app_config);
        }
        return $app;
    }
...
/**
 * ExampleBlogAppException 封装应用程序运行过程中产生的异常
 *
 * @package app
 */
class ExampleBlogAppException extends QException
{
