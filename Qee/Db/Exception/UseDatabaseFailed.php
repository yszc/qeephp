...
/**
 * 定义 Qee_Db_Exception_UseDatabaseFailed 异常
 *
...
/**
 * Qee_Db_Exception_UseDatabaseFailed 异常指示选择要使用的数据库时出错
 *
 * @package Database
 * @subpackage Exception
 * @author 起源科技(www.qeeyuan.com)
 * @version 1.0
 */
class Qee_Db_Exception_UseDatabaseFailed extends Qee_Exception
{
    public $dbtype;
    public $driver;
    public $database;
