...
do {
    ...
    if (!isset($viewConfig['liteDir'])) {
        ...
        throw new Qee_View_Exception_NotConfiguration('Template Lite');
    }

    $filename = $viewConfig['liteDir'] . '/class.template.php';
    if (!file_exists($filename)) {
        //require_once 'Qee/View/Exception/InitEngineFailed.php';
        throw new Qee_View_Exception_InitEngineFailed('Template Lite');
    }
...
/**
 * Qee_View_Lite 提供了对 TemplateLite 模板引擎的支持
 *
 * @package Core
 * @author 起源科技(www.qeeyuan.com)
 * @version 1.0
 */
class Qee_View_Lite extends Template_Lite
{
    /**
     * 构造函数
     */
